...
public class HDB_Manager extends SystemUser{
    ...
    public void CreateBTOProject(String projectName, String neighborhood, int twoRoomUnits, int threeRoomUnits, 
                             String openDate, String closeDate, int officerSlots) {
        if (officerSlots > 10) {
        ...
        // Create new project
        Project newProject = new Project(projectName, neighborhood, 0, 0, twoRoomUnits, threeRoomUnits, 
                                        openDate, closeDate, this, officerSlots, new ArrayList<>(), true, "ALL");
    ...
    public void EditBTOProject(String projectName, String newNeighborhood, int newTwoRoomUnits, int newThreeRoomUnits, 
                           String newOpenDate, String newCloseDate, int newOfficerSlots) {
        // Get project
    ...
    public void ApproveOrRejectWithdrawal(String applicantNRIC, String projectName, boolean approve) {
        ...
        if (approve) {
            ...
            withdrawalRequest.initiator.flatTypeBooked = "";
